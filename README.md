...
실제로 배포되고 사용자가 쓰는 웹 플랫폼, 모바일 앱, 텔레그램 미니앱, 백엔드 시스템을 만듭니다. 깔끔한 구조, 실제 배포, 실제 사용자 — 이 세 가지를 기준으로 개발합니다.

데이터 모델부터 API, 프론트엔드, 그리고 직접 운영하는 VPS의 Docker와 Nginx까지 전 과정을 맡습니다. 현재는 SaaS와 텔레그램 서비스를 4개 언어로 만들고 있습니다.
