...
대표 프로젝트는 가구 커머스 플랫폼 **Zinfurn**입니다. GraphQL API 설계, JWT 인증과 소셜 로그인, 주문·쿠폰 처리, WebSocket 실시간 알림, 관리자 페이지까지 혼자 개발했습니다. 쿠폰 사용은 동시 요청에도 초과되지 않도록 원자적으로 처리했고, 상품 정보는 AI로 자동 번역되어 다국어로 제공됩니다.
