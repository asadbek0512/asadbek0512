<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/asadbek0512/asadbek0512/main/assets/logo-dark.svg">
  <img src="https://raw.githubusercontent.com/asadbek0512/asadbek0512/main/assets/logo-light.svg" alt="AK" height="60">
</picture>
...
| [**LifeOS**](https://t.me/lifeos_uz_bot) | Life-management Telegram Mini App — tasks, habits, prayer times, 4 languages | Next.js · NestJS · Aiogram |
| [**TicketCatch**](https://t.me/ticketcatch_bot) | Flight-price watcher — ~140 airports, parallel multi-source scraping, per-user alerts | Python · Aiogram · Scraping |
| [**ZuhorBooks**](https://zuhorbooks.uz) | Online bookstore — catalog, ordering flow, reader-focused UI | React · Express · MongoDB |
| [**Royal Empire**](https://royalempire.uz) | Cinematic studio portfolio — 3D visuals, GSAP motion, multilingual | Next.js · Three.js · GSAP |

Every project above runs in production on my own VPS — Docker, Nginx, SSL, CI/CD included.
...
실제로 배포되고 사용자가 쓰는 웹 플랫폼, 모바일 앱, 텔레그램 미니앱, 백엔드 시스템을 만듭니다. 깔끔한 구조, 실제 배포, 실제 사용자 — 이 세 가지를 기준으로 개발합니다. 데이터 모델부터 API, 프론트엔드, 그리고 직접 운영하는 VPS의 Docker와 Nginx까지 전 과정을 맡습니다. 현재는 SaaS와 텔레그램 서비스를 4개 언어로 만들고 있습니다.

---

## Contact

<picture><source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/asadbek0512/asadbek0512/main/assets/ak-dark.svg"><img src="https://raw.githubusercontent.com/asadbek0512/asadbek0512/main/assets/ak-light.svg" height="16" align="center" /></picture>&nbsp; **Portfolio:** [khusanovdev.uz](https://khusanovdev.uz)  
<img src="https://raw.githubusercontent.com/asadbek0512/asadbek0512/main/assets/linkedin.svg" height="16" align="center" />&nbsp; **LinkedIn:** [in/asadbek1](https://linkedin.com/in/asadbek1)  
