...
I build production web platforms, Telegram Mini Apps, and backend systems that ship — clean architecture, real deployment, real users. Currently building SaaS and Telegram products, open to full-stack / backend roles.
